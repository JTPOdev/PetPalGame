...
public class Stats : MonoBehaviour 
{
    ...
    private const int BATH_DECREASE_AMOUNT = 2;
    private const int FUN_DECREASE_AMOUNT = 2;
    private const int THIRST_DECREASE_AMOUNT = 2;
    private const int HUNGER_DECREASE_AMOUNT = 2;
    private const int ENERGY_DECREASE_AMOUNT = 2;
